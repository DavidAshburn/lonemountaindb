...
class PoetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poet" do
    assert_difference("Poet.count") do
      post poets_url, params: { poet: { bio: @poet.bio, first: @poet.first, last: @poet.last, nameplate: @poet.nameplate } }
    end
  ...
  test "should update poet" do
    patch poet_url(@poet), params: { poet: { bio: @poet.bio, first: @poet.first, last: @poet.last, nameplate: @poet.nameplate } }
